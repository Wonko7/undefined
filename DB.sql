...
GRANT ALL PRIVILEGES ON article_authors, article_categories, article_tags, articles, author_roles, authors, categories, comments, projects, reset_links, roles, tags, temp_authors, tags_uid_seq, articles_uid_seq, comments_uid_seq, temp_authors_uid_seq TO web;
